...
- (void)requestGetUserPhoto
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@/energy/do/chargeapp/getuserphoto.do?;sessionid=%@",IP,self.sessionid];
...
- (void)accountTableViewCellDidClickRechargeButtonWith:(LQAccountTableViewCell *)cell btn:(UIButton *)btn
{
    ...
    else
    {
        ...
        orderModel.money = accountItemModel.moneyofamount;
