...
@property (nonatomic, strong) UIButton *btn;//充值金额选择按钮的“过度”按钮
...
- (void)doLoading
{
    ...
    self.rechargeAmountTextField.text = @"1223";
...
- (IBAction)clickYuanBtn:(UIButton *)sender
{
    ...
    [self setBtnLayerWithBtn:sender borderColor:[UIColor blueColor]];
    
    [self.btn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [self setBtnLayerWithBtn:self.btn borderColor:[UIColor lightGrayColor]];
