...
- (instancetype)initWithDays:(int)days showType:(CalendarShowType)type singleShowMonth:(int)singleShowMonth modelArrar:(NSMutableArray *)modelArr {
    self = [super init];
    if (!self) return nil;
    self.days = days;
    self.type = type;
...
- (instancetype)initWithDays:(int)days showType:(CalendarShowType)type singleShowMonth:(int)singleShowMonth
{
    self = [super init];
    if (!self) return nil;
    self.days = days;
...
+ (instancetype)calendarWithDays:(int)days showType:(CalendarShowType)type singleShowMonth:(int)singleShowMonth modelArrar:(NSMutableArray *)modelArr
{
    return [[self alloc] initWithDays:days showType:type singleShowMonth:singleShowMonth modelArrar:modelArr];
}

+ (instancetype)calendarWithDays:(int)days showType:(CalendarShowType)type singleShowMonth:(int)singleShowMonth
{
    return [[self alloc] initWithDays:days showType:type singleShowMonth:singleShowMonth];
}
